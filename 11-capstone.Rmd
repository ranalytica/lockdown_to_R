...
Now that we are here. We have gained so many skill sets. This course is a culmination of all the knowledge learned during the specialization. I utilize my time efficiently during Covid19-lockdown. Learned valuable skills from installing R and RStudio, loading, subsetting, wrangling, exploring, using statistical inference, and applying machine learning to our data sets. I now have the ability to create data products geared to a specific customers. 
